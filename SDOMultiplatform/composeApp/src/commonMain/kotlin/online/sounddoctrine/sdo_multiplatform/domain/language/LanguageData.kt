...
//import java.util.Locale // For JVM target, if needed for `languageName` logic
// For other platforms, you'll need platform-specific ways to get localized strings
...
//
//// You can also create an extension for the "none" case if needed
//fun LanguageData.Companion.none(): LanguageData {
//    return LanguageData(languageCode = "", sourceCountryFlag = "")
//}